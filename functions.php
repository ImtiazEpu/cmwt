...
function launcher_assets() {
    if (is_page()){
        $launcher_page_templete = basename(get_page_template());
        if ($launcher_page_templete == 'launcher.php'){
	        /*CSS File Injecting*/
	        ...
	        $launcher_year  = get_field( 'year' );
	        $launcher_month = get_field( 'month' );
	        $launcher_day   = get_field( 'day' );
	        wp_localize_script( "main-jquery-js", "countdowdata", array(
		        "year"  => $launcher_year,
